...
def is_nmap_scan?(pkt)
	...
	return nmap_binary.match(pkt.payload)
end
...
def is_nikto_scan?(pkt)
	...
	return nikto_binary.match(pkt.payload)
end
...
def is_credit_card?(pkt)
	...
	return visa.match(pkt.payload) ||
	mastercard.match(pkt.payload) ||
	discover.match(pkt.payload) ||
	amex.match(pkt.payload)
end
